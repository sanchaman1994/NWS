      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I am an experienced Developer with over a decade of professional
            expertise in the field. throught my carrer, I have had the privilege
            of collaborating with prestigious organizations, contributing to
            their success and rouwth.
          </p>
            ...
            {infoList.map(({ icon, icondark, title, description }, index) => (
              <li
                ...
                className="border-[0.5px]
                 border-gray-400 rounded-xl p-6 
          ...
          <ul className="flex items-center gap-3 sm:gap-5">
            {toolsData.map((tool, index) => (
              <li
                className="flex items-center justify-center w-12 sm:w-14 aspect-square border bborder-gray-400 rounded-lg cursor-pointer
